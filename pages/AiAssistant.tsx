    ...
    <div className="h-[calc(100vh-100px)] flex flex-col max-w-4xl mx-auto">
      <div className="flex-none mb-4 flex justify-between items-center">
        <div>
          ...
          <p className="text-slate-500">Full Access to Collections, Transactions, Accounts, and Receipts.</p>
        </div>
            ...
            <div className="flex justify-start">
              <div className="bg-white border border-slate-200 rounded-2xl rounded-tl-none p-4 shadow-sm text-slate-800">
                ...
                <p className="whitespace-pre-wrap">
                  Hello! I have full access to all group collections, member contribution records, account balances, and transaction logs.<br/><br/>
                  • Ask me anything like: <i>"Who collected today?"</i>, <i>"What are Andrew's total contributions?"</i>, or <i>"Show recent expenses"</i>.<br/>
                  • Command me or upload a receipt to draft transactions: <i>"Andrew paid 1,000 today"</i> or attach a photo!
                </p>
              </div>
            </div>
          )}
